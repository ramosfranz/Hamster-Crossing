class ThemeManager {
    ...
    static hamsterAssets = {
        ...
        canvasBackground: "url('assets/images/backgrounds/snowflabg.gif'), url('assets/images/backgrounds/bg_merry1.png')",
    ...
    mint: {
        ...
        canvasBackground: "url('assets/images/backgrounds/heartmintbg.gif'), url('assets/images/backgrounds/bg_mint.png')",
    ...
    static updateThemeVariables() {
        ...
        // Update the entire page background
        document.body.style.backgroundImage = assets.pageBackground;
        document.documentElement.style.backgroundImage = assets.pageBackground;
    }
