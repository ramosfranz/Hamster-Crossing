import { settings, setSearchInProgress, resetTimers, timers, searchInProgress} from '../manager/stateManager.js';
import { initializeGrid, generateRandomGrid, addRandomWeights, setGoal, getGrid, start, getGoal, getStart, rows, cols } from '../manager/gridManager.js';
...
import { registerCanvas, drawGrid, ctx, canvases } from '../animation/visualizer.js';
import { algorithms } from '../popup/settingsPopUp.js';
...
export function updateButtonText() {
    const backButton = document.querySelector("#backButton .button-text");
    const settingsButton = document.querySelector("#settingsButton .button-text");
