...
const closeBtn = document.getElementById("closeGachaPopup");
const popup = document.getElementById("popup");
const openBtn = document.getElementById("openPopup");

// Audio elements for sound effects
const rollSFX = new Audio('assets/sounds/roll_SFX.mp3');
const clickSFX = new Audio('assets/sounds/click_SFX.mp3');
...
chooseBtn.addEventListener("click", () => {
    ...
    console.log("Applying assets for selected hamster:", ThemeManager.selectedHamster, assets);
    ...
    alert(`You've selected ${ThemeManager.selectedHamster}! Click 'Start the Game' to begin.`);
});
