import { setSelectedHamster, getHamsterAssets, selectedHamster } from './themeManager.js';
...
// Update the click handler for hamster choices
hamsterChoices.forEach((choice) => {
    choice.addEventListener("click", () => {
        ...
        // Update the selected hamster using themeManager's function
        ...
        if ((selected === "hamuStar" && !hamuStarUnlocked) || (selected === "chiikawa" && !chiikawaUnlocked)) {
            ...
            // Use the setSelectedHamster function from themeManager
            if (setSelectedHamster(selected)) {
...
chooseBtn.addEventListener("click", () => {
    ...
    // Get the current selected hamster from themeManager
    const selectedHamster = selectedHamster; // Now using the imported variable
...
document.querySelector('button[onclick="window.location.href=\'game.html\'"]').addEventListener("click", function(e) {
    ...
    // Get the current selection from themeManager
    const selectedHamster = selectedHamster;
    
    if (!selectedHamster || 
        (selectedHamster === "hamuStar" && !hamuStarUnlocked) || 
        (selectedHamster === "chiikawa" && !chiikawaUnlocked)) {
