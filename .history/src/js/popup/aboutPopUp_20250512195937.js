        ...
        <div class="aboutContent">
            ...
            <div class="algorithmsList">
                ...
                <div class="algorithmColumn" data-algorithm="gridBased">
                    ...
                    <div class="algorithmDescription">
                        Grid-Based Pathfinding breaks down the game world into a grid, allowing precise movement and obstacle detection by checking each grid cell.
                    </div>
                </div>
                <div class="algorithmColumn" data-algorithm="bfs">
                    ...
                    <div class="algorithmDescription">
                        Breadth-First Search explores all neighboring paths equally, systematically checking all possible routes in layers to find the shortest path.
                    </div>
                </div>
                <div class="algorithmColumn" data-algorithm="waypoint">
                    ...
                    <div class="algorithmDescription">
                        Waypoint Navigation allows players to set specific points for the hamster to follow, creating a custom path through the level.
                    </div>
                </div>
            </div>
        </div>
