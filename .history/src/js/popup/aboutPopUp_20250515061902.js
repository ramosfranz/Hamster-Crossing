...
const hamuTeachDiv = document.getElementById("hamuTeach");
...
hamuTeachDiv.addEventListener("click", openAboutPopup);
...
function startHamuAnimation() {
    ...
    if (hamuAnimationInterval !== null) {
        clearInterval(hamuAnimationInterval);
    }
    if (hamuFrameInterval !== null) {
        clearInterval(hamuFrameInterval);
    }
