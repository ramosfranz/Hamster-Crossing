import { getGoal, rows, cols,  getGrid } from '../manager/gridManager.js';
import { ctx, canvases, spriteSheet, GROUND_SPRITE_WIDTH, GROUND_SPRITE_HEIGHT } from '../animation/visualizer.js';

// Seed constants
export const SEED_SPRITE_WIDTH = 26;
export const SEED_SPRITE_HEIGHT = 48;
const SEED_ANIMATION_INTERVAL = 300;
export const goalReachedByAlgorithm = {};
...
export function setGoalReached(algorithmId, reached) {
    goalReachedByAlgorithm[algorithmId] = reached;
}
...
export function redrawSeedOverPath() {
    ...
    for (const algorithmId in ctx) {
     if (goalReachedByAlgorithm[algorithmId]) continue;
