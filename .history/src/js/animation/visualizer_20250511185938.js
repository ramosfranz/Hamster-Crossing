...
import { selectedHamster } from '../popup/gachaPopUp.js';
...
function initializeThemeAssets() {
    // Get the selected hamster's assets from ThemeManager
    const hamsterAssets = ThemeManager.getHamsterAssets(selectedHamster);
    
    // Update sprite sources
    spriteSheet.src = hamsterAssets.ground;
    hamsterSpriteSheet.src = hamsterAssets.sprite;
    
    console.log("Visualizer initialized with theme assets for:", selectedHamster, hamsterAssets);
}
