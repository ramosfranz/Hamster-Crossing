...
import { getHamsterAssets } from '../manager/themeManager.js';
...
// Initialize with theme assets
function initializeThemeAssets() {
    // Get the selected hamster's assets directly from themeManager
    // This automatically pulls from localStorage via the themeManager module
    const hamsterAssets = getHamsterAssets();
    
    // Update sprite sources
    spriteSheet.src = hamsterAssets.ground;
    hamsterSpriteSheet.src = hamsterAssets.sprite;
    
    console.log("Visualizer initialized with theme assets:", hamsterAssets);
}
