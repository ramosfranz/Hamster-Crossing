...
const hamuFrames = [
    '../src/assets/images/hamster_falling/hamu_fall1.png',
    '../src/assets/images/hamster_falling/hamu_fall2.png'
];

const berryFrames = [
    '../src/assets/images/hamster_falling/berry_fall1.png',
    '../src/assets/images/hamster_falling/berry_fall2.png'
];

const merryFrames = [
    '../src/assets/images/hamster_falling/merry_fall1.png',
    '../src/assets/images/hamster_falling/merry_fall2.png'
];

const mintFrames = [
    '../src/assets/images/hamster_falling/mint_fall1.png',
    '../src/assets/images/hamster_falling/mint_fall2.png'
];
