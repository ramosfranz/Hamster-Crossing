...
export function setGoalReached(reached) {
    const previousState = isGoalReached;
    isGoalReached = reached;
    
    if (isGoalReached && !previousState) {
        // Goal was just reached - trigger any goal-reached specific behaviors
...
// Function to reset goal reached state
export function resetGoalReached() {
    isGoalReached = false;
    console.log('Goal reached state reset');
}
