...
// Create the inner popup content
aboutPopup.innerHTML = `
    <div class="innerPopup">
        <div class="popupHeader">
            <h4>About Hamster Crossing</h4>
            <button id="closeAboutPopup">X</button>
        </div>
...
// Remove the old about section since we're replacing it with a popup
const oldAboutSection = document.getElementById("aboutSection");
if (oldAboutSection) {
    oldAboutSection.remove();
}

// Make sure triggerHamsterAnimation is accessible
// This function should already be defined in gachaPopUp.js, but we'll reference it here
function triggerHamsterAnimation() {
    const hamster = document.getElementById("hamster");
    if (!hamster) return; // Check if element exists
    
    hamster.style.animation = "none";
    void hamster.offsetWidth;
    hamster.style.animation = "hamsterFall 2s linear forwards, hamsterFrame 0.5s steps(2) infinite";
